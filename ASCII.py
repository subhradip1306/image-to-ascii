...
def resize(image, new_width=203):
...
def image_to_ascii(image_path, output_width=203):
    try:
...
image_path ='zelda.jpg' #input('Please enter the image path: ')
